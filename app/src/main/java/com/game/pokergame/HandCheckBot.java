...
public class HandCheckBot {
    ...
    public static void evalCardBot() {
        isPairBot();
        isStraightBot();

        if(royaleFlush == 1 && isFLushBot() == true){
            winBot = 10;
            royaleFlush = 0;
            straight = 0;
            for (int i = 0; i < 13; i++) {
        ...
        else if (isFLushBot() == true && straight ==1){
            winBot = 9;
            royaleFlush = 0;
            straight = 0;
            for (int i = 0; i < 13; i++) {
    ...
    public static void isFlushCheckBot() {
        int o1 = Gameboard.deck.get(7);
        int o2 = Gameboard.deck.get(8);
    ...
    public static boolean isFLushBot() {
        isFlushCheckBot();
    ...
    public static void gameHandBot(){
        int r1 = Gameboard.deck.get(2);
        int r2 = Gameboard.deck.get(3);
        int r3 = Gameboard.deck.get(4);
        int r4 = Gameboard.deck.get(5);
    ...
    // The Check varaiables are for making sure the player has that card in their hand.
    public static void isStraightBot(){
        gameHandBot();
        for (int i = 0; i < 8; i++){
